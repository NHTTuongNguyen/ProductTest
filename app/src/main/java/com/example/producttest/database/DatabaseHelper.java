...
//        contentValues.put(COLUMN_image,product.getImage());
    ...
    public long updateProduct(Product product){
        ...
        contentValues.put(COLUMN_PRICE,product.getPrice());
        contentValues.put(COLUMN_DES,product.getDes());
        long result = sqLiteDatabase.update(PRODUCT,contentValues,COLUMN_ID+"=?",new String[]{product.getId()});
        return result;
    }
...
//        String dbPath = mContext.getDatabasePath("Product.sqlite").getPath();
